    ...
    <>
      <tr>
        ...
        <td>
          <div className="cu-avatar">
            ...
            <div className="cu-name">
              <p className="name">
                {user.cName} {user.sName}
                <span>(کد مشتری: {user.cCode})</span>
              </p>
        ...
        <td>
          <Status
            class={"order-status"}
            status={user.active == true ? "true" : "false"}
            text={user.active == true ? "فعال" : "غیرفعال"}
          />
        </td>
        <td className="p-r">
          ...
          >
            <div
              className="sub-option sub-delete"
