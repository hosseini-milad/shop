...
function QuickView(props) {
  ...
  return (
    ...
    >
      {(close) => (
        <div className="imgPopUpHolder">
          <img
            className="modalImg"
            src={
              productInfo.data && productInfo.data.thumbUrl
                ? siteApiUrl + productInfo.data.thumbUrl
                : "/images/motor-oil.jpg"
            }
            alt={productInfo.data && productInfo.data.sku}
          />
