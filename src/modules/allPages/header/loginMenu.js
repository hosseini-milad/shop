...
function LoginMenu(props) {
      ...
      .then(
        (result) => {
          ...
          if (result.error) {
            ...
            setError("کد برای شما پیامک گردید");
  ...
  const handleLogin = () => {
    const postOptions = {
      method: "post",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ otp: otp, phone: mobile_phone }),
    };
          ...
          {!login ? (
            ...
            <div className="minicartData">
              <div className="item-cart-quantity" style={{ display: "grid" }}>
                ...
                ></input>
                <small className="loginCounter">
                  {counter ? counter : ""}{" "}
                  {counter ? (
                    <button disabled>ارسال مجدد</button>
                  ) : (
                    <button onClick={handleSendCode}>ارسال مجدد</button>
                  )}
                </small>
                <div className="cartpopup">
        ...
        <div className="Loggedin">
          ...
          <form>
            <input
              ...
              type="submit"
              value="خروج"
              className="modal-sub-btn logout"
            />
          </form>
        </div>
      )}
