...
const CartToSepidar=async(data,faktorNo,user,stock,cartOff,orderNo,official)=>{
        ...
        var query ={
            ...
            notNullCartItem.map((item,i)=>{
                const price = findPayValuePrice(item.price,official?3:4)
