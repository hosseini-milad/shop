      ...
      <div className="row-box">
        <div className="probs-wrapper">
          <div className="input-wrapper">
            <StyleInput
              title={tabletrans.productSku[props.lang]}
              direction={props.direction}
              class={"formInput"}
              defaultValue={def ? def.sku : ""}
              action={(e) =>
            ...
            />
            <StyleInput
              title={tabletrans.perBox[props.lang]}
              direction={props.direction}
              class={"formInput"}
              defaultValue={def ? def.perBox : ""}
              action={(e) =>
                props.setProductChange((prevState) => ({
                  ...prevState,
                  perBox: e,
            ...
            <StyleSelect
              ...
              defaultValue={!def.active ? "غیرفعال" : "فعال"}
              options={StatusList}
              label={"Title"}
              action={(e) =>
                props.setProductChange((prevState) => ({
            ...
            <StyleSelect
              ...
              direction={props.direction}
              class={"formInput halfWidth"}
              defaultValue={content ? content.brandData : ""}
              options={brand ? brand : []}
              label={"title"}
              action={(e) =>
                props.setProductChange((prevState) => ({
            ...
            <StyleSelect
              ...
              direction={props.direction}
              class={"formInput halfWidth"}
              defaultValue={content ? content.catData : ""}
            ...
            {filterList &&
              filterList.map((filter, i) => (
                <StyleSelect
                  ...
                  key={i}
                  defaultValue={
                    def && def.filters ? def.filters[filter.enTitle] : ""
                  }
                  options={filter ? filter.optionsP : []}
                  label="title"
                  action={(e) =>
