  ...
  return (
    <div className="printArea officialprint">
      <div className="userInfo">
        ...
        >
          <small>
            شماره سریال: <b>{orderInfo.Number}</b>
          </small>
          <small>
            {" "}
            تاریخ: <b>{new Date(orderInfo.Date).toLocaleDateString("fa-IR")}</b>
          </small>
        </div>
      </div>
      ...
      <table className="hesabfaMainTable">
        <tbody>
          ...
          <tr>
            ...
            <td className="number-td">
              {normalPriceCount(orderInfo.Discount)}
            </td>
            <td className="number-td">
              {normalPriceCount(orderInfo.Addition)}
            </td>
            <td className="number-td"></td>
            <td className="number-td">{normalPriceCount(orderInfo.Tax)}</td>
            <td className="number-td">
              {normalPriceCount(orderInfo.NetPrice)}
            </td>
          </tr>
        </tbody>
      </table>
        ...
        <div className="footer-row">
          <div className="pay-col">
            ...
            <div className="pay-item">
              <p>نقدی</p>
              <span className="pay-checkbox">
                {orderInfo.SaleTypeRef == 3 ? (
