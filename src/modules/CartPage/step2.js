      ...
      <div className="cartSideBar">
        <div className="cartSidePrice">
          <div className="priceCalc">
            ...
            <div style={{ textAlign: "left" }}>
              ...
              <strong>
                ...
                {transportDetail ? transportDetail.logCode : "انتخاب کنید"}
              </strong>
            </div>
          </div>
          ...
          <div className="priceTotal">
            ...
            <strong>
              {sumPrice(cart.totalprice + "+" + cart.transportationPrice) +
                " تومان "}
            </strong>
          </div>
          <form>
        ...
        {cart.totalprice ? (
          transportDetail ? (
            ...
            <a href="#" className="modal-sub-btn disabled">
              انتخاب نحوه ارسال
            </a>
          )
        ) : (
