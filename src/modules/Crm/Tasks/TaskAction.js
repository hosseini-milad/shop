...
function TaskAction(props) {
  ...
  const updateTask = (action) => {
    ...
    const postOptions = {
      ...
      body: JSON.stringify({ _id: data ? data._id : "", status: action }),
    };
    ...
    if (data.result.InvoiceID) {
      return (
        <div className="taskAction">
          ...
          <button
            type="button"
            className="btn-crm btn-crm-info"
            onClick={() =>
              (window.location.href = "/orders/print/" + data.orderNo)
            }
          >
            <p>چاپ سفارش</p>
          </button>
  ...
  // }
    ...
    return (
      <div className="taskAction">
        ...
        <button
          type="button"
          className="btn-crm btn-crm-edit"
        ...
        {(data && data.taskStep === "done") || data.taskStep === "edit" ? (
          <button
            type="button"
            className="btn-crm btn-crm-cancel"
        ...
        {data && data.taskStep === "prepare" ? (
          <button
            ...
            className="btn-crm btn-crm-info"
            onClick={() =>
              (window.location.href = "/orders/invoice/" + data.orderNo)
            }
          >
            <p>حواله خروج</p>
          </button>
