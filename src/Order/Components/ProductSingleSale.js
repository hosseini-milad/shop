        ...
        <div className="product-wrapper">
          <div className="product-tile">
            ...
            <div className="product-img">
              <img src={env.siteApiUrl+ data.thumbUrl} alt="oil"/>
            </div>
            ...
            <form className="product-option-num">
              <>
              <div className={"inputGroup selectedGroup"}>
                <input id={"radios"+props.id} name="radio" type="radio" style={{display: "none"}} checked/>
                <label htmlFor={"radios"+props.id}>
                  <p>تعداد</p>
                  <span>{data.count.quantity}</span>
...
export default ProductSingleSale
