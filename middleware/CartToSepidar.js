...
const CartToSepidar=async(data,faktorNo,user,stock,cartOff,orderNo,payValue)=>{
        ...
        var query ={
            ...
            "CurrencyRef":1,
            "SaleTypeRef": payValue?payValue:3,
            "Duty":0.0000,
            ...
            notNullCartItem.map((item,i)=>{
                const price = findPayValuePrice(item.price,payValue?payValue:3)
