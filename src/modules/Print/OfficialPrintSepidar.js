        ...
        <div className="printArea officialprint">
          <div className="userInfo">
              ...
              <div className="hesabfaSection hesabfaDate" style={{minWidth: "240px"}}>
                <small>شماره سریال: <b>{orderInfo.cartNo}</b></small>
                <small> تاریخ: <b>{new Date(orderInfo.progressDate).toLocaleDateString('fa-IR')}</b></small>
              </div>
            </div>
                ...
                <tr>
                  <td colSpan={8}>
                    <div className="table-total">
                      <p>{Num2persian(normalPriceRound(data.orderData.totalPrice))} ریال</p>
                      <p>جمع کل</p>
                    </div>
                  </td>
                  <td>{normalPriceRound(data.orderData.totalFee)}</td>
                  <td>{normalPriceRound(data.orderData.totalDiscount)}</td>
                  <td>{normalPriceRound(data.orderData.Addition)}</td>
                  <td></td>
                  <td>{normalPriceRound(data.orderData.totalTax)}</td>
                  <td>{normalPriceRound(data.orderData.totalPrice)}</td>
                </tr>
              </tbody>
            </table>
