...
function Header(props) {
  ...
  const handleOilMenuHover = () => {
    setOilMenu("block");
  };
  const handleOilMenuOut = () => {
    setOilMenu("none");
  };
  const handleLubMenuHover = () => {
    setLubMenu("block");
  };
  const handleLubMenuOut = () => {
    setLubMenu("none");
  };
  const handleAccMenuHover = () => {
    setAccMenu("block");
  };
  const handleAccMenuOut = () => {
    setAccMenu("none");
  };
  ...
  return (
    <header>
      <div className="topTop">
        <>
          <span>
            اگر همکار هستید و دنبال بهترین قیمت و ضمانت کالای اصل میگردید
            <a href="tel:9-02634011002"> با ما تماس بگیرید </a>
          </span>
      ...
      <div className="topHeader">
        <a className="logo" href="/">
          <img
            src="https://sharifoilco.com/assets/imgs/header-logo.png"
            alt="Sharifi Oil Logo"
            width="192px"
            height="54px"
          />
        </a>
        <div className="search">
          <div className="searchPlace">
            <input
              type="text"
              placeholder="جستجو"
              className="v-auto-search__input"
            ...
            />
            <a
              href={"/category?search=" + searchPhrase}
              className="v-auto-search__search-icon"
            >
        ...
        <div className="icons">
          <div className="account">
            ...
            >
              <i
                className="icon-size circleIcon fas fa-car"
                style={{
                  backgroundColor:
                    currentHover === 1 ? "var(--second-color)" : "",
                }}
              ></i>
              <div className="account-heading">جستجوی سریع</div>
              <i className="fas fa-angle-down"></i>
              <div
                className="megaMenuHeader"
                style={{ visibility: searchMenu }}
              >
                <div className="megaSideBar">
                  <h3>جستجوی خودرو</h3>
                  <p>
                    سریع ترین و ساده ترین راه برای تعیین اینکه به کدام محصولات
                    نیاز دارید. مشاهده همه راهنماها ›
                  </p>
                </div>
            ...
            <a
              ...
              href={
                ...
                siteApiUrl +
                  "/" +
                  setting.data.find(
                    (record) => record.payload.item === "catalogue_file"
                  ).payload.value
              }
            >
              <i
                className="icon-size circleIcon fas fa-book"
                style={{
                  backgroundColor:
                    currentHover === 2 ? "var(--second-color)" : "",
                }}
              ></i>
          ...
          <div className="account">
            ...
            >
              <i
                ...
                style={{
                  backgroundColor:
                    currentHover === 3 ? "var(--second-color)" : "",
                }}
              ></i>
          ...
          <div className="cart">
            ...
            >
              {cart && cart.cart && cart.cart.length ? (
                <b className="cartNum">{cart.cart.length}</b>
              ) : (
                ""
              )}
              <i
                className="icon-size circleIcon fas fa-shopping-cart"
                style={{
                  backgroundColor:
                    currentHover === 4 ? "var(--second-color)" : "",
                }}
              ></i>
      ...
      <div className="menu">
        <div className="menuNavBar">
          <ul>
            <li
              className="menuItem"
              onMouseOver={handleOilMenuHover}
              onMouseOut={handleOilMenuOut}
            >
              <a href="/category/motor-oil"> روغن موتور</a>
            ...
            <li
              className="menuItem"
              onMouseOver={handleLubMenuHover}
            ...
            >
              ...
              <div className="MegaMenuLable" style={{ display: lubMenu }}>
                <MegaMenuLubricant
                  setting={setting}
                  category={props.category && props.category.data}
                  cats={props.cats}
                />
              </div>
            </li>
            <li
              className="menuItem"
              onMouseOver={handleAccMenuHover}
        ...
        <div className="contact">
          {!url ? (
            <h1>فروشگاه اینترنتی روغن موتور</h1>
          ) : (
            <h2>فروشگاه اینترنتی روغن موتور</h2>
          )}
